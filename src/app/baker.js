...
const ScatterChart = ({ onCalculationStatusChange }) => {
  ...
  const [isCalculated, setIsCalculated] = useState(false); // New state for calculation status
  ...
  useEffect(() => {
    ...
    socket.onmessage = (event) => {
      ...
      if (data) {
        ...
        onCalculationStatusChange(position_calculate === "True"); // Update calculation status based on received value
      }
    };
